...
function SplashCursor({
    ...
    useEffect(() => {
        ...
        function getWebGLContext(canvas: HTMLCanvasElement) {
            ...
            if (!gl) return { gl: null, ext: {} }; // Safety check

            let halfFloat: any;
            let supportLinearFiltering;

            // Extension handling needs explicit typing or casting for TS
            if (isWebGL2) {
    ...
    `;
      ...
      `
        ...
        function initFramebuffers() {
            ...
            const filtering = (ext as any).supportLinearFiltering ? gl.LINEAR : gl.NEAREST;
